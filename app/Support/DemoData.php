...
final class DemoData
{
    ...
    {
        return [
            ['id' => 1, 'category_id' => 1, 'category_name' => 'Coffee', 'category_slug' => 'coffee', 'name' => 'Rose Latte', 'slug' => 'rose-latte', 'description' => 'Espresso, fresh milk and a restrained rose finish.', 'regular_price' => 6.50, 'promotional_price' => null, 'dietary_labels' => ['Contains dairy'], 'cover_image' => '/public/assets/images/cafe-900.webp', 'is_featured' => 1, 'options' => [['id' => 1, 'option_group' => 'size', 'name' => 'Regular', 'price_adjustment' => 0, 'is_default' => 1], ['id' => 2, 'option_group' => 'size', 'name' => 'Large', 'price_adjustment' => 1, 'is_default' => 0], ['id' => 3, 'option_group' => 'temperature', 'name' => 'Hot', 'price_adjustment' => 0, 'is_default' => 1], ['id' => 4, 'option_group' => 'temperature', 'name' => 'Iced', 'price_adjustment' => .5, 'is_default' => 0]]],
            ['id' => 2, 'category_id' => 2, 'category_name' => 'Tea & Botanical', 'category_slug' => 'tea-botanical', 'name' => 'Botanical Iced Tea', 'slug' => 'botanical-iced-tea', 'description' => 'A fragrant chilled infusion with citrus and garden herbs.', 'regular_price' => 5.50, 'promotional_price' => 4.80, 'dietary_labels' => ['Vegan'], 'cover_image' => '/public/assets/images/cafe-900.webp', 'is_featured' => 1, 'options' => [['id' => 5, 'option_group' => 'size', 'name' => 'Regular', 'price_adjustment' => 0, 'is_default' => 1], ['id' => 6, 'option_group' => 'size', 'name' => 'Large', 'price_adjustment' => 1, 'is_default' => 0]]],
            ['id' => 3, 'category_id' => 3, 'category_name' => 'Bakes', 'category_slug' => 'bakes', 'name' => 'Pistachio Financier', 'slug' => 'pistachio-financier', 'description' => 'A tender almond cake with pistachio and browned butter.', 'regular_price' => 4.20, 'promotional_price' => null, 'dietary_labels' => ['Contains nuts', 'Contains dairy', 'Contains egg'], 'cover_image' => '/public/assets/images/cafe-900.webp', 'is_featured' => 0, 'options' => []],
        ];
    }
